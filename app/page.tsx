...
import { CalendarDays, Code, Laptop, Mail, MessageSquare, Phone, Smartphone } from "lucide-react"
              ...
              <div className="container px-4 md:px-6">
                ...
                <div className="mx-auto grid max-w-5xl items-stretch gap-6 py-12 lg:grid-cols-3">
                  <div className="group relative overflow-hidden rounded-lg border bg-background p-6 shadow-md transition-all hover:shadow-xl h-full flex flex-col">
                    ...
                    <p className="text-muted-foreground mt-2 flex-grow">{t("web-development-desc")}</p>
                  </div>
                  <div className="group relative overflow-hidden rounded-lg border bg-background p-6 shadow-md transition-all hover:shadow-xl h-full flex flex-col">
                    <div className="flex h-12 w-12 items-center justify-center rounded-full bg-primary/10 text-primary mb-4">
                    ...
                    <p className="text-muted-foreground mt-2 flex-grow">{t("app-development-desc")}</p>
                  </div>
                  <div className="group relative overflow-hidden rounded-lg border bg-background p-6 shadow-md transition-all hover:shadow-xl h-full flex flex-col">
                    <div className="flex h-12 w-12 items-center justify-center rounded-full bg-primary/10 text-primary mb-4">
                    ...
                    <p className="text-muted-foreground mt-2 flex-grow">{t("consulting-desc")}</p>
                  </div>
                </div>
              </div>
            </section>
                ...
                <div className="grid gap-6 lg:grid-cols-2 lg:gap-12">
                  ...
                  <div className="flex flex-col justify-center space-y-4">
                    <div className="space-y-2">
                      ...
                      <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">{t("who-we-are")}</h2>
                      <p className="max-w-[600px] text-muted-foreground md:text-xl/relaxed">{t("about-description")}</p>
                    </div>
              ...
              <div className="container px-4 md:px-6">
                <div className="flex flex-col items-center justify-center space-y-4 text-center">
                  <div className="space-y-2">
                    ...
                    <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">{t("recent-work")}</h2>
                    <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
              ...
              <div className="container px-4 md:px-6">
                <div className="flex flex-col items-center justify-center space-y-4 text-center">
                  <div className="space-y-2">
                    ...
                    <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">{t("get-in-touch-title")}</h2>
                    <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                ...
                <div className="mx-auto grid max-w-5xl items-start gap-6 py-12 lg:grid-cols-2">
                  <div className="grid gap-6">
                    <div className="grid gap-1">
                      <h3 className="text-xl font-bold">{t("contact-information")}</h3>
                      <p className="text-muted-foreground">{t("contact-channels")}</p>
                    </div>
                    <div className="grid gap-4">
                      <div className="flex items-center gap-2">
                        <Mail className="h-5 w-5 text-primary" />
                        <a href="mailto:sapesolutions.contact@gmail.com" className="text-sm hover:underline">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm">{t("schedule-consultation")}</span>
                      </div>
                    </div>
                  </div>
                  <div className="grid gap-6">
          ...
          <footer className="w-full border-t bg-background py-6">
            <div className="container flex flex-col items-center justify-between gap-4 px-4 md:flex-row md:px-6">
              ...
              <p className="text-center text-sm text-muted-foreground md:text-left">
                &copy; {new Date().getFullYear()} Sape Solutions. {t("rights-reserved")}
              </p>
